...
const DaftarProyek = React.lazy(() => import('./views/ManajemenProyek/DaftarProyek/daftarproyek'));
const DaftarClient = React.lazy(() => import('./views/ManajemenProyek/DaftarClient/daftarclient'));
